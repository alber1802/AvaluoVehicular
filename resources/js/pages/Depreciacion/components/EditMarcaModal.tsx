...
import { type MarcaDepreciacion } from '../types';
            ...
            <DialogContent className="max-w-2xl bg-white dark:bg-[#1a2c3a] border-[#e2e8f0] dark:border-[#20384b]">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-[#64748b] dark:text-white/70 mt-1">
                                Actualiza la información de la marca de vehículo
                            </p>
                        </div>
                    </div>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 mt-4">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        {/* Valor Residual */}
                        <div className="space-y-2">
                            <Label htmlFor="edit-valor_residual" className="text-[#1e293b] dark:text-white/90">
                                Valor Residual <span className="text-red-500">*</span>
                            </Label>
                            <Input
                                id="edit-valor_residual"
                                type="number"
                                step="0.001"
                                min="0.107"
                                max="0.20"
