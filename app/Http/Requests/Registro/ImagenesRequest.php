...
class ImagenesRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Validaciones estrictas para cada imagen
            'imagenes.*.file' => [
                'required',
                'file',
    ...
    public function messages(): array
    {
        return [
            ...
            'imagenes.max' => 'No puede subir más de 20 imágenes a la vez.',
            
            'imagenes.*.file.required' => 'El archivo de imagen es requerido.',
